    ...
    <div className="account-blocked-modal">
      ...
      >
        ...
        <div className="account-blocked-container">
          <p className="content">You may have been temporarily blocked from uploading new files. You may, however, continue to view and take
            actions on existing uploads. If you feel this was a mistake please contact <Link href="mailto:support@web3.storage.com">support@web3.storage.com</Link></p>


          <Button onClick={() => modalState[1](false)} className="confirm">Confirm</Button>
        </div>
      </Modal>
    </div>
  );
